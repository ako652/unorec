...
export const caseStudy = {
  ...
  summary: [
    'We are building the future community. UNOREC Private Social and Humanitarian Program at Kumba Principal Prison empowers young inmates through education reformation, and transformation .',
  ],
  logo,
  image: { src: imageHero },
  image1: { src: prison2 },
  ...
  testimonial: {
    ...
    content:
      'Our program aims to provide quality education, foster personal growth, and build self-esteem to help inmates reintegrate into society.',
  },
}
